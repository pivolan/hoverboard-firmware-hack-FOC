...
#define CTRL_MOD_REQ    TRQ_MODE        // [-] Control mode request: OPEN_MODE, VLT_MODE (default), SPD_MODE, _MODE. Note: SPD_MODE and TRQ_MODE are only available for CTRL_FOC!
